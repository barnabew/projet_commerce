...
# Afficher le contenu selon la page active
if st.session_state["current_page"] == "resume":
...
elif st.session_state["current_page"] == "geographique":
    st.markdown("<div class='section-header'>📍 Analyse Géographique</div>", unsafe_allow_html=True)
    st.info("Contenu de la page Géographique à venir...")

elif st.session_state["current_page"] == "produit":
    st.markdown("<div class='section-header'>🛍️ Analyse des Produits</div>", unsafe_allow_html=True)
    st.info("Contenu de la page Produits à venir...")
    ...
    st.info("Contenu de la page Clients à venir...")

elif st.session_state["current_page"] == "recommandations":
    st.markdown("<div class='section-header'>💡 Recommandations</div>", unsafe_allow_html=True)
    st.info("Contenu de la page Recommandations à venir...")
